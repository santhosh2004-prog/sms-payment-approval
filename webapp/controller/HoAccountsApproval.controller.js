...
_loadPaymentData: function () {
    ...
    oModel.read("/PaymentHeaderSet", {
        ...
        success: function (oData) {
            ...
            /* ===================================================== */
            /* 🔹 FILTER ONLY ITEMS WHERE PM STATUS CONDITION       */
            /* ===================================================== */
            ...
            var aFilteredHeaders = aHeaders.map(function (oHeader) {
                ...
                var aApprovedItems = aItems.filter(function (oItem) {
                    ...
                    /* Skip items already approved by HOD or beyond */
                    if (sLastApprovedStatus >= 1) {
                        return false;
                    }
                ...
                /* 🔹 If no valid items → skip header */
                if (aApprovedItems.length === 0) {
                    return null;
                }

                /* ===================================================== */
                /* 🔹 CALCULATE HEADER TOTALS FROM FILTERED ITEMS       */
                /* ===================================================== */
                ...
                /* ===================================================== */
                /* 🔹 RETURN HEADER WITH CALCULATED TOTALS              */
                /* ===================================================== */
            ...
            console.log("Headers after filtering:", aFilteredHeaders.length);
  ...
  handleDialogConfirm: function () {
    ...
    if (sActionType === "REJECT") {
        ...
        if (aItemsWithoutRemarks.length > 0) {
            console.log("❌ REJECTION BLOCKED - Missing Pm remarks");
...
onGst2aRefChange: function (oEvent) {
    ...
    MessageToast.show(
        ...
        onRemarksChange: function (oEvent) {
            ...
            // Update the tree data model
            oContext.getModel().setProperty(oContext.getPath() + "/HodApprRemarks", sNewValue);
...
_sendDeepApprovalPayload: function (aPayloadItems, sActionType, oHeader) {
  ...
  oMappedItem.RejectedBy = oItem.HodUserId || "";
  oMappedItem.RejectionDate = toEdmDateTime(new Date());
  oMappedItem.RejectorDesignation = "HOD";
}
