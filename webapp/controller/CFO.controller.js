...
,
      ...
      onPmApprAmountChange: function (oEvent) {
        ...
        oContext
          .getModel()
          .setProperty(oContext.getPath() + "/CfoApprAmt", sFormattedValue);

        console.log(
          "CFO Approved Amount updated in tree data model:",
          sFormattedValue,
        );
        MessageToast.show(
          "CFO Approved Amount updated to ₹" +
            fNewValue.toLocaleString("en-IN", {
              minimumFractionDigits: 2,
              maximumFractionDigits: 2,
            }),
      ...
      onRemarksChange: function (oEvent) {
        ...
        oContext
          .getModel()
          .setProperty(oContext.getPath() + "/CfoApprRemarks", sNewValue);

        console.log("CFO Remarks updated in tree data model:", sNewValue);
      },
      ...
      _logCurlCommand: function (oBatchCallDetails) {
        ...
        sCurlCommand +=
          "  --data-raw '" + oBatchCallDetails.body.replace(/'/g, "\\'") + "'";
      ...
      _sendPutRequestsForSelectedItems: function (
        ...
        var fnProcessNextItem = function (iIndex) {
          console.log(
            "=== PROCESSING ITEM " + (iIndex + 1) + "/" + iTotalCount + " ===",
          );
